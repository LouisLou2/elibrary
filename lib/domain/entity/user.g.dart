...
void _userSerialize(
  ...
  writer.writeBool(offsets[5], object.role);
...
User _userDeserialize(
  ...
  final object = User(
    ...
    gender: reader.readBoolOrNull(offsets[1]),
    lastLogin: reader.readDateTimeOrNull(offsets[2]),
    location: reader.readLongOrNull(offsets[3]),
    name: reader.readString(offsets[4]),
    role: reader.readBool(offsets[5]),
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> locationEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'location',
        value: value,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> roleEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'role',
        value: value,
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, int?, QQueryOperations> locationProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, bool, QQueryOperations> roleProperty() {
    return QueryBuilder.apply(this, (query) {
